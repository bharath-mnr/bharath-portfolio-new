    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <a
            href="https://leetcode.com/u/bharathmnr06/"
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 rounded-full font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/25"
          >
